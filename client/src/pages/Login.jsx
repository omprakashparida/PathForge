  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 min-h-screen">
        ...
        {/* Left Side Content */}
        <div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-16 text-white text-center lg:text-left z-10">
          ...
          <p className="text-gray-400 text-base sm:text-lg mb-10 max-w-xl mx-auto lg:mx-0">
            Track progress, maintain streaks, and continue building your career.
          </p>
        ...
        {/* Login Form */}
        <div className="flex justify-center items-center px-4 sm:px-6 lg:px-10 py-10 z-10">
          <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-3xl w-full max-w-md p-6 sm:p-10">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              {/* Password & Forgot Password Grouping */}
