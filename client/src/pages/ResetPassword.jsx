...
function VerifyOTP() {
  ...
  // 1. Added two separate loading states for the two different buttons
  ...
  const handleVerify = async (e) => {
    ...
    setIsVerifying(true); // Turn verify loading ON
    ...
    try {
      ...
      setIsVerifying(false); // Turn verify loading OFF
    }
  };

  const handleResend = async () => {
    setIsResending(true); // Turn resend loading ON
    ...
    try {
      ...
      setIsResending(false); // Turn resend loading OFF
    }
  };
